	...
	var methods = {
		...
		createButtons: function () {
			...
			this.pagingPrev = new Element('a', {
				...
				events: { click: function (e) { if(!this.loading) { this.prev(); this.toggleButtons(); } } .bind(this) }
			...
			this.pagingNext = new Element('a', {
				...
				events: { click: function (e) { if(!this.loading) { this.next(); } this.toggleButtons(); } .bind(this) }
			}).inject(this.container, 'after');
		},
